package com.ucielcorp.backend.security.controller;
...
import com.ucielcorp.backend.security.service.RolService;
import com.ucielcorp.backend.security.service.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUser loginUsuario, BindingResult bindingResult){
        ...
        // Apartir de la autenticación generamos el token
